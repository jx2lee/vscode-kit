...
#[derive(Parser, Debug)]
#[command(name = "code-kit", version, about = "Generate VS Code templates", long_about = None)]
pub struct Cli {
    #[command(subcommand)]
    command: Commands,
}
...
pub fn run() -> i32 {
    ...
    match cli.command {
        ...
        Commands::Generate {
            ...
            // Auto-enable prompt when stdin is a TTY, or when --interactive is explicitly set
